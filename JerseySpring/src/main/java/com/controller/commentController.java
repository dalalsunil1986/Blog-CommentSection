...
public class CommentController {
	...
	public CommentData getCommentById(@PathParam(value = "commentId") Integer commentId, @Context UriInfo uri) {

		log.info("Starting Comment Controller Get Comment By Id");

		Comment comment = com.getCommentById(commentId);

		log.error(uri.getBaseUri());
		CommentData comdata = new CommentData();
		...
		comdata.setSelf(new Href("/comments/comment/" + comment.getCommentId()));
